...
import { 
  User, Settings, Calendar, Award, TrendingUp, 
  Utensils, Edit, X, Save, PlusCircle 
} from 'lucide-react';

import '../index.css';
import '../pages/WorkoutsPage.css'; // Import the WorkoutsPage CSS
        ...
        <>
          <header className="workouts-header">
            ...
            <ul>
                ...
                <li><a href="#" className="sign-out" onClick={(e) => { e.preventDefault(); handleSignOut(); }}>Sign Out</a></li>
              </ul>
            </nav>
          </header>
...
const styles = {
  ...
  // Updated header styles to match workouts page
  workoutsHeader: {
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  workoutsTitle: {
    fontSize: '1.75rem',
    fontWeight: 'bold',
    color: '#10B981', // Primary green color as in workouts
    margin: 0,
  },
  workoutsNav: {
    display: 'flex',
  ...
  workoutsNavLink: {
    textDecoration: 'none',
    color: '#4B5563', // Gray color from workouts
    fontSize: '1rem',
    fontWeight: '500',
    padding: '5px 10px',
    borderRadius: '4px',
  ...
  // You can remove these old header styles if not used elsewhere
  header: null,
